    ...
    public class loginHelper
    {
        public static bool login(string userCode,string userPassword,db.dbEntities dc)
        {
            ...
            if (entry != null)
            {
                ...
                rui.sessionHelper.saveValue("client.pass", entry.password);
                rui.sessionHelper.saveValue("client.email", entry.email);
                rui.sessionHelper.saveValue("client.tel", entry.telphone);
        ...
        {
            return rui.sessionHelper.getValue<string>("client.tel");
        }
        public static string getLoginEmail()
        {
            return rui.sessionHelper.getValue<string>("client.email");
        }
        public static string getLoginPass()
        {
            return rui.sessionHelper.getValue<string>("client.pass");
        }
